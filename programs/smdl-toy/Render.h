...
/// radiance is projected onto the bands beside the spectral sum, at every
/// pass alike, since the guided combination resolves to the plain mean
/// anyway. When this returns the band film holds every sample the
