...
Refer to xref:intrinsics.adoc[the listing of all intrinsics].
...
Refer to xref:function-attributes.adoc[the listing of all function attributes].
...
For convenience and readability, the SMDL compiler allows the `:=` 
