...
/// silica and calcium fluoride by Malitson's fits and magnesium fluoride by
/// Dodge's, the low index of an antireflection coating.
///
...
/// replaced: `BK7` for N-BK7. `SILICA` and `FLUORITE` are aliases for fused
