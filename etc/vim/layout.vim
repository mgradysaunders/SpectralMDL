...
syn keyword layoutLightSetting contained power temperature color angle blend scale

syn keyword layoutCameraSetting contained dims look_from look_to up fovy fstop
...
syn region layoutAssetBlock contained matchgroup=layoutDelim start="{" end="}"
      ...
      \ layoutTransform,layoutMaterialOp
...
syn region layoutImportBlock contained matchgroup=layoutDelim start="{" end="}"
      \ contains=@layoutCommon,layoutTransform,layoutMaterialOp
