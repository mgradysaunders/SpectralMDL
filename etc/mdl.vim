...
hi def link mdlSubst      Constant
hi def link mdlIntrinsic  Macro
...
syn keyword mdlStatement   return break continue let in typedef cast defer preserve return_from unreachable visit 
...
syn keyword mdlType texture_2d texture_3d texture_cube texture_ptex light_profile image_t state_t
