...
// Malitson and Dodge print each C as a wavelength in micrometers, where a
// datasheet prints its square.
...
// catalog 2017-01-20b, fused silica and calcium fluoride are Malitson's
// fits, and magnesium fluoride is Dodge's, all as the refractiveindex.info
// database (public domain, CC0 1.0) carries them:
//
...
// at 24 C.
//
// M. J. Dodge, "Refractive properties of magnesium fluoride", Appl. Opt.
// 23, 1980-1985 (1984), the ordinary ray, fitted from 0.2 to 7.0 um, at
// 19 C. The crystal is birefringent, and the ordinary index is the one a
// thin film of it is quoted at, as the low index of an antireflection
// coating.
//
// Gungnir's etc/scripts/convert_lens.py keeps a copy of these names and of
// the aliases below, so that a converted lens names a built-in glass rather
// than defining it again. A name added here goes there too.
constexpr CatalogData CATALOG[] = {
    {"MGF2",
     {0.48755108f, 0.39875031f, 2.3120353f},
     {squared(0.04338408), squared(0.09461442), squared(23.793604)}},
    {"CAF2",
